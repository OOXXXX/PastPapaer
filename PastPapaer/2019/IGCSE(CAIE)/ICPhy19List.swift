...
struct ICPhy19List: View {
    var body: some View {
        List(ICPhy19Data) { xxx in
            
            NavigationLink(destination: ICPhy19Detail(xxx: xxx)) {
                ICPhy19Row(xxx: xxx)
            }
        }
...
struct ICPhy19List2: View {
    var body: some View {
        List(ICPhy19Data2) { xxx2 in
            
            NavigationLink(destination: ICPhy19Detail2(xxx2: xxx2)) {
                ICPhy19Row2(xxx2: xxx2)
            }
        }
...
struct ICPhy19: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
struct ICPhy19_2: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
let ICPhy19Data: [ICPhy19] = load("OLPhy19.json")
let ICPhy19Data2: [ICPhy19_2] = load("OLPhy19-2.json")
