...
struct ICGeo19List: View {
    var body: some View {
        List(ICGeo19Data) { xxx in
            
            NavigationLink(destination: ICGeo19Detail(xxx: xxx)) {
                ICGeo19Row(xxx: xxx)
            }
        }
...
struct ICGeo19List2: View {
    var body: some View {
        List(ICGeo19Data2) { xxx2 in
            
            NavigationLink(destination: ICGeo19Detail2(xxx2: xxx2)) {
                ICGeo19Row2(xxx2: xxx2)
            }
        }
...
struct ICGeo19: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
struct ICGeo19_2: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
let ICGeo19Data: [ICGeo19] = load("OLGeo19.json")
let ICGeo19Data2: [ICGeo19_2] = load("OLGeo19-2.json")
