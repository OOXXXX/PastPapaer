...
struct ICCs19List: View {
    var body: some View {
        List(ICCs19Data) { xxx in
            
            NavigationLink(destination: ICCs19Detail(xxx: xxx)) {
                ICCs19Row(xxx: xxx)
            }
        }
...
struct ICCs19List2: View {
    var body: some View {
        List(ICCs19Data2) { xxx2 in
            
            NavigationLink(destination: ICCs19Detail2(xxx2: xxx2)) {
                ICCs19Row2(xxx2: xxx2)
            }
        }
...
struct ICCs19: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
struct ICCs19_2: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
let ICCs19Data: [ICCs19] = load("OLCs19.json")
let ICCs19Data2: [ICCs19_2] = load("OLCs19-2.json")
