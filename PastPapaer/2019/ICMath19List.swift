...
struct ICMath19List: View {
    var body: some View {
        List(ICMath19Data) { xxx in
            
            NavigationLink(destination: ICMath19Detail(xxx: xxx)) {
                ICMath19Row(xxx: xxx)
            }
        }
...
struct ICMath19List2: View {
    var body: some View {
        List(ICMath19Data2) { xxx2 in
            
            NavigationLink(destination: ICMath19Detail2(xxx2: xxx2)) {
                ICMath19Row2(xxx2: xxx2)
            }
        }
...
struct ICMath19: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
struct ICMath19_2: Hashable, Codable, Identifiable {
    var id: Int
    var name: String
    var url: String
...
let ICMath19Data: [ICMath19] = load("OLMath19.json")
let ICMath19Data2: [ICMath19_2] = load("OLMath19-2.json")
